...
package testgit.hereissomething_0_1;
...
/**
 * Job: HereIsSomething Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class HereIsSomething implements TalendJob {
	...
	private final String jobName = "HereIsSomething";
	private final String projectName = "TESTGIT";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					HereIsSomething.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(HereIsSomething.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_TESTGIT_HereIsSomething = new byte[0];
		static byte[] commonByteArray_TESTGIT_HereIsSomething = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.jobid;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TESTGIT_HereIsSomething.length) {
					if (length < 1024
							&& commonByteArray_TESTGIT_HereIsSomething.length == 0) {
						commonByteArray_TESTGIT_HereIsSomething = new byte[1024];
					} else {
						commonByteArray_TESTGIT_HereIsSomething = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TESTGIT_HereIsSomething, 0,
						length);
				strReturn = new String(commonByteArray_TESTGIT_HereIsSomething,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TESTGIT_HereIsSomething) {

				try {

					int length = 0;

					this.jobid = dis.readLong();

					this.filename = readString(dis);

					this.email = readString(dis);

					this.isprocessed = readByteArray(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeByteArray(this.isprocessed, dos);
		...
		public String toString() {
			...
			sb.append(",isprocessed=" + String.valueOf(isprocessed));
			sb.append("]");
		...
		public int compareTo(row2Struct other) {
			...
			returnValue = checkNullsAndCompare(this.jobid, other.jobid);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_1 = "SELECT \n  \"edfi_jk\".\"public\".\"uploads\".\"jobid\", \n  \"edfi_jk\".\"public\".\"uploads\".\"filename\", \n  \"edfi_j"
						+ "k\".\"public\".\"uploads\".\"email\", \n  \"edfi_jk\".\"public\".\"uploads\".\"isprocessed\"\nFROM \"edfi_jk\".\"public\"."
						+ "\"uploads\"";
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							if (rs_tDBInput_1.getObject(1) != null) {
								row2.jobid = rs_tDBInput_1.getLong(1);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row2.filename = routines.system.JDBCUtil.getString(
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							row2.isprocessed = null;
						} else {

							if (rs_tDBInput_1.getObject(4) != null) {
								row2.isprocessed = rs_tDBInput_1.getBytes(4);
							} else {
								row2.isprocessed = null;
							}
						}
						...
						strBuffer_tLogRow_1.append(String.valueOf(row2.jobid));
						...
						if (row2.isprocessed != null) { //

							strBuffer_tLogRow_1
									.append(java.nio.charset.Charset
											.defaultCharset()
											.decode(java.nio.ByteBuffer
													.wrap(row2.isprocessed))
											.toString());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					String messagetMsgBox_1 = "Hello git user!";
	...
	public static void main(String[] args) {
		final HereIsSomething HereIsSomethingClass = new HereIsSomething();

		int exitCode = HereIsSomethingClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = HereIsSomething.class
					.getClassLoader().getResourceAsStream(
							"testgit/hereissomething_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = HereIsSomething.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : HereIsSomething");
		}
...
/************************************************************************************************
 * 49288 characters generated by Talend Open Studio for Data Integration on the
 * December 19, 2018 2:17:00 PM CST
 ************************************************************************************************/
